...
RSpec.describe HTMLDiff do
  ...
  describe 'multi-language support' do
    ...
    it 'properlies handle RTL text with HTML' do
    ...
    it 'supports Myanmar (Burmese)' do
    ...
    it 'supports mixed scripts and languages' do
    ...
    it 'handles mixed languages with HTML tags' do
  ...
  describe 'HTML entities' do
    ...
    it 'correctlies process HTML entities in attributes' do
